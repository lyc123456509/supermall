<template>
  <div class="rule" :style="{ top: props.topLight + 'rem' }">
    <div
      class="sidebar_hint"
      :style="ruleItemStyle"
      @click="rulesHandle"
      v-if="info.landingPageResponse.rulsUrlValue"
      v-html="props.ruleContent"
    ></div>
    <div
      class="sidebar_hint"
      :style="ruleItemStyle"
      @click="customsHandle"
      v-if="info.landingPageResponse.customerUrlValue && props.customerStatus"
      >客<br />服</div
    >
