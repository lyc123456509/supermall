...
function x() {
  ...
  return (
    g([
      ...
      'MozAppearance' in
        (null !== (n = null === (e = document.documentElement) || void 0 === e ? void 0 : e.style) && void 0 !== n ? n : {}),
      ...
      return t(this, function (t) {
        switch (t.label) {
              ...
              [
                ...
                new Promise(function (e, t) {
                  ...
                  var c = function () {
                    ...
                    o ||
                      ('complete' ===
                      (null === (n = null === (e = l.contentWindow) || void 0 === e ? void 0 : e.document) || void 0 === n
                        ? void 0
                        : n.readyState)
                        ? i()
                        : setTimeout(c, 10));
          ...
          case 5:
            t.sent(), (t.label = 6);
          case 6:
            return (null === (c = null === (a = l.contentWindow) || void 0 === a ? void 0 : a.document) || void 0 === c ? void 0 : c.body)
              ? [3, 8]
              : [4, o(i)];
          case 7:
            return t.sent(), [3, 6];
...
function B(e) {
  ...
  return n(this, void 0, void 0, function () {
    ...
    return t(this, function (t) {
      switch (t.label) {
        case 0:
          for (n = document, i = n.createElement('div'), a = new Array(e.length), c = {}, O(i), s = 0; s < e.length; ++s)
            (u = I(e[s])), O((l = n.createElement('div'))), l.appendChild(u), i.appendChild(l), (a[s] = u);
          t.label = 1;
        case 1:
...
var ne = {
  ...
  timezone: function () {
    ...
    var r,
      o = ((r = new Date().getFullYear()), -Math.max(p(new Date(r, 0, 1).getTimezoneOffset()), p(new Date(r, 6, 1).getTimezoneOffset())));
...
function te(e) {
  ...
  return { score: n, comment: '$ if upgrade to Pro: https://fpjs.dev/pro'.replace(/\$/g, '' + t) };
}
function re(n) {
