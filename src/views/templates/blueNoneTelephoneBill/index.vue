<template>
  <div>
    <div class="container">
      ...
      <div class="header">
        <!-- <span style="font-size: 0.21rem; margin-top: 0.3rem">·29.9元充值{{ info.appName }}会员·</span> -->
        <span style="font-size: 0.62rem; margin: 0.1rem 0 0.3rem 0">会员名额已锁定！</span>
        <p class="count-down"
      ...
      <div class="hf_c_box">
        <div class="hf_title">会员优惠券包说明</div>
