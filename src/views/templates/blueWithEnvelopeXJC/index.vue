<template>
  <div>
    <preEnvelopeXJC v-if="step === 1" @change-step="changeStep" />

    <div class="container" v-else>
      <img class="logo_img" :src="info.landingPageResponse.logoUrl" alt="" />
      <div class="header">
        <span style="font-size: 0.21rem; margin-top: 0.3rem">·{{ showMoney }}元充值{{ info.appName }}会员·</span>
        <span style="font-size: 0.62rem; margin: 0.1rem 0 0.3rem 0">锁定百元话费券！</span>
        <p class="count-down"
      ...
      <div class="content">
        ...
        />
        <p class="wait-save"
          >待节省金额 <span style="color: #3678f7">{{ new BigNumber(info.phoneData.cssClass || 100).minus(showMoney) }}</span></p
        >
        <div class="list">
          <div class="item">
            <p>20 <span>元</span></p>
...
<script setup lang="ts">
  ...
  import preEnvelopeXJC from '../../prePage/preEnvelopeXJC/index.vue';
