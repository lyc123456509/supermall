  ...
  <div>
    <div class="container">
      ...
      <div class="header">
        ...
        <div>
          <span style="font-size: 0.38rem; margin: 0.1rem 0 0.3rem 0">锁定百元券包！</span>
          <p class="count-down"
      ...
      <div class="content">
        ...
        <UserBook @change="isAgreeCB" :checkImg="[select_icon, unselect_icon]" :phone="phone" />
      </div>
      <div class="hf_c_box">
        <div class="hf_title">券包说明</div>
