  ...
  <div>
    <div class="container">
      ...
      <div class="header">
        ...
        <div>
          <span style="font-size: 0.38rem; margin: 0.1rem 0 0.3rem 0">锁定百元话费券包！</span>
          <!-- <p class="count-down"
      ...
      <div class="content">
        ...
        />
        <div class="coupon-title">话费券包</div>
        <div class="list">
          <div class="item">
            <p>100 <span>元</span></p>
            <p>会员价: 29.9元</p>
        ...
        <nut-button :loading="submitLoading" class="scale-animation nowGet" size="large" @click="getPayHandle">立即抢购</nut-button>
        <UserBook @change="isAgreeCB" :phone="phone" :auto="false" :defaultChecked="false" :checkImg="[select_icon, unselect_icon]" />
      </div>
      <div class="hf_c_box">
