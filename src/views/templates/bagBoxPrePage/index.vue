<template>
  <armBandit v-if="step === 1" @change-step="changeStep" />
  <div v-else>
    <div class="wp-landing30 pro4">
      ...
      <div class="choose-pay-mode">
        <div class="item selected">
          <!-- <div class="icon"><img src="/src/assets/bagBox/wx1.svg" /></div> -->
      ...
      <div class="user-comment pro4-comment">
        <div class="item">
          ...
          <div class="comment">
            ...
            >
            <div class="pic-list">
              <div class="pic"><img src="/src/assets/bagBox/pic1.jpg" /></div>
              <div class="pic"><img src="/src/assets/bagBox/pic2.jpg" /></div>
              <div class="pic"><img src="/src/assets/bagBox/pic3.jpg" /></div>
            </div>
          </div>
        </div>
        <div class="item">
          ...
          <div class="comment">
            ...
            >
            <div class="pic-list">
              <div class="pic"><img src="/src/assets/bagBox/pic4.jpg" /></div>
              <div class="pic"><img src="/src/assets/bagBox/pic5.jpg" /></div>
              <div class="pic"><img src="/src/assets/bagBox/pic6.jpg" /></div>
            </div>
          </div>
        </div>
      </div>
...
<script setup lang="ts">
  ...
  import armBandit from '/@/views/prePage/armBandit/index.vue';
  ...
  const { page, end, resetTime, list, levelList, phone, content, title, step } = toRefs(state);
</script>
...
<style lang="scss" scoped>
  ...
  .nut-swiper-btns {
    ...
    .btn {
      width: 0.4rem;
      height: 0.7rem;
      background: url('/src/assets/bagBox/bg1.png') no-repeat;
  ...
  .wp-landing30 {
    ...
    .high-pro-name {
      ...
      .label {
        ...
        text-align: center;
        vertical-align: top;
        background: url(/src/assets/bagBox/bg14.png) no-repeat 0 0;
        background-size: 100% 100%;
      }
      .text {
        color: #e1e1e2;
    ...
    .high-pro-para {
      width: 100%;
      margin-top: 0.25rem;
      background: url(/src/assets/bagBox/bg9.png) no-repeat 0 0;
      background-size: 100% 100%;
      &::after {
        content: '';
        display: block;
    ...
    .ensure {
      ...
      .logo {
        ...
        height: 0.36rem;
        border-radius: 3px;
        background: #fff url(/src/assets/bagBox/apple-logo.svg) no-repeat 50% 50%;
    ...
    .choose-pay-mode {
      ...
      .item {
        ...
        .radio {
          border: none;
          background: url(/src/assets/bagBox/tick1.png) no-repeat 50% 50%,
    ...
    .is-agree {
      ...
      .checkbox {
        background: url(/src/assets/bagBox/tick2.png) no-repeat 50% 50%;
    ...
    & > div {
      ...
      & > div {
        ...
        .confirm-btn {
          ...
          color: #fff;
          font-size: 0.48rem;
          background: url(/src/assets/bagBox/bg4.png) no-repeat 0 0;
          background-size: 100% 100%;
