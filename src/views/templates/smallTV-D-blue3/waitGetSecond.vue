<template>
  <div class="container">
    ...
    <img src="@/assets/smallTV-D-blue/98js.png" alt="" class="csj" />
    ...
    <div class="second-hide">
      ...
      <img src="@/assets/smallTV-D-blue/btn_gz.png" class="nowGet" alt="" @click="goWx" />
      <div class="steps">
    ...
    />
    <CompanyInfo style="color: #297be7; margin-top: 0.7rem" />
...
<style lang="scss" scoped>
  .container {
    ...
    .second-hide {
      ...
      .steps {
        margin-top: 0.71rem;
        background-image: url('/@/assets/smallTV-D-blue/stepLine.png');
        background-repeat: no-repeat;
