  ...
  <div>
    <div class="container">
      ...
      <div class="header">
        ...
        <span style="font-size: 0.52rem; margin: 0.5rem 0 0.3rem 0">锁定百元话费优惠券！</span>
        <p class="count-down"
      ...
      <div class="content">
        ...
        <nut-button :loading="submitLoading" class="scale-animation nowGet" size="large" @click="getPayHandle">立即领取</nut-button>
