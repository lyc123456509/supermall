  ...
  <div>
    <div class="container">
      <div class="header">
        ...
        <span style="font-size: 0.62rem; margin: 0.7rem 0 0.1rem 0">锁定百元话费券</span>
        <div class="countDown"><span>支付剩余时间</span><CountDown :time="15" /></div>
      </div>
      <div class="content">
        <nut-input
          type="tel"
        ...
        <div class="btnBox scale-animation">
          <span class="btn_hint_price">省{{ new BigNumber(Number(info.phoneData.cssClass)).minus(showMoney) }}元</span>
