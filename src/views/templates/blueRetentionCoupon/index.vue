  ...
  <div>
    <div class="container">
      <div class="header">
        ...
        <span style="font-size: 0.62rem; margin: 0.4rem 0 0.3rem 0; font-weight: bold">锁定百元话费优惠券！</span>
        <p class="count-down"
      ...
      <div class="content">
        ...
        <div class="pay_amount">
          <span class="text">实际到账话费优惠券：</span>
        ...
        <div class="buttonBox scale-animation">
          ...
          <nut-button :loading="submitLoading" class="nowGet" size="large" @click="getPayHandle">立即领取</nut-button>
        </div>
        <UserBook @change="isAgreeCB" :phone="phone" />
      </div>
      <div class="hf_c_box">
        <div class="hf_title">口袋大师话费优惠券</div>
