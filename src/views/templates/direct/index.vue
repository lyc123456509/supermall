  ...
  <div>
    <div class="container">
      ...
      <div class="box">
        <div class="hf-coupon">
          <img class="line" src="https://y-qiwan.obs.cn-north-4.myhuaweicloud.com:443/qwhz-h5/page/h5_hf/29_hf/line.png" alt="" />
          <PayMethod @change="payMethodCB" style="margin-left: 0.2rem" />
          <nut-input
            type="tel"
            v-model="phone"
      ...
      <div class="use_flow">
        ...
        <div class="flow_content _flex_bew">
          ...
          <div
            ...
            >领<span class="price_">100</span>元话费券</div
          >
        </div>
      </div>
      <companyInfo />
