<template>
  <div class="container">
    <div class="animation-char" v-if="state.showCharAnimation">
      <img src="@/assets/smallTV-D-blue/太.png" alt="" />
      <img src="@/assets/smallTV-D-blue/棒.png" alt="" />
      <img src="@/assets/smallTV-D-blue/了,.png" alt="" />
      <img src="@/assets/smallTV-D-blue/恭.png" alt="" />
      <img src="@/assets/smallTV-D-blue/喜.png" alt="" />
      <img src="@/assets/smallTV-D-blue/您.png" alt="" />
      <img src="@/assets/smallTV-D-blue/！.png" alt="" style="width: 0.24rem" />
    </div>
    <img src="@/assets/smallTV-D-blue/gx.png" alt="" class="wait" v-if="guess === '1'" />
    <img src="@/assets/smallTV-D-blue/waitGet.png" alt="" class="wait" v-else />
    <img src="@/assets/smallTV-D-blue/true.png" alt="" class="guess" v-if="guess === '1'" />
    <img src="@/assets/smallTV-D-blue/false.png" alt="" class="guess" v-else-if="guess === '-1'" />
    <img src="@/assets/smallTV-D-blue/js.png" alt="" class="csj" />
    <div class="bottom-container">
      ...
      <img src="@/assets/smallTV-D-blue/btn_lq.png" class="nowGet" alt="" @click="submitHandle" />
    ...
    />
    <CompanyInfo style="color: #297be7; margin-top: 0rem" />
...
<style lang="scss" scoped>
  ...
  .container {
    background-image: url('/@/assets/smallTV-D-blue/new_bg.png');
    ...
    .bottom-container {
      ...
      background-image: url(/@/assets/smallTV-D-blue/bottom.png);
      background-size: 100% auto;
      background-repeat: no-repeat;
      width: 100vw;
      height: 4.13rem;
