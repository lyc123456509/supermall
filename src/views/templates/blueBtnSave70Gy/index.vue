  ...
  <div>
    <div class="container">
      ...
      <div class="header">
        ...
        <span style="margin-top: 0.2rem">{{ showMoney }}专享会员权益</span>
        <span style="font-size: 0.62rem; margin: 0.3rem 0 0.3rem 0">锁定百元话费券包！</span>
        <p class="count-down"
      ...
      <div class="content">
        ...
        />
        <p class="wait-save"
          >待节省金额 <span style="color: #3678f7">{{ new BigNumber(Number(info.phoneData.cssClass)).minus(showMoney) }}</span></p
        >
        <div class="list">
          <div class="item">
            <p>20 <span>元</span></p>
        ...
        <div class="btnBox scale-animation">
          <p class="btn_hint_price"
            >节省 <span>{{ new BigNumber(Number(info.phoneData.cssClass)).minus(showMoney) }}元</span></p
          >
      ...
      <companyInfo :companyStatus="false" :addressStatus="false" :filingStatus="false" />
      <sideBar :refund-status="true" />
    </div>
  </div>
</template>
