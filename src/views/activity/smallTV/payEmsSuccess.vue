<template>
  <div class="container">
    ...
    <div class="tip">- 可在公众号【剧场中转站】查询物流单号</div>
    <!-- <div class="btn" @click="goWx">立即关注</div> -->
    <div class="bottom">
      <img src="@/assets/activity/smallTV/gzh_logo.png" alt="" class="logo" />
      <!-- <span>看剧积分*990</span> -->
      <div @click="goWx">去看剧<img src="@/assets/activity/smallTV/icon_gd.png" alt="" /></div>
    </div>
  </div>
</template>
...
<script lang="ts" setup>
  ...
  const goWx = async () => {
    ...
    window.location.href = 'https://s.eastday.com/?vid=2832&source=ad&dramaNum=1#/';
  };
</script>
